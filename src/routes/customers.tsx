...
export default function CustomersPage() {
  ...
  return (
    <Layout>
      ...
      {viewingInvoice && <InvoiceModal inv={viewingInvoice} onClose={() => setViewingInvoice(null)} />}
      {viewingOrder && <OrderInvoiceModal order={viewingOrder} onClose={() => setViewingOrder(null)} />}
      {viewingRepair && <RepairInvoiceModal repair={viewingRepair} onClose={() => setViewingRepair(null)} />}
    </Layout>
  );
}
