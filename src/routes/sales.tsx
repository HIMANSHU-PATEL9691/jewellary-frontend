...
import { useLocalState, inr, type Invoice } from "@/lib/storage";
    ...
    <Layout>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <table className="w-full text-sm"><thead className="text-left text-muted-foreground border-b"><tr><th className="py-2">Invoice</th><th>Date</th><th>Customer</th><th>Type</th><th>Mode</th><th>Items</th><th className="text-right">Total</th></tr></thead>
            <tbody>{[...filtered].sort((a,b) => b.createdAt.localeCompare(a.createdAt)).map(i => (<tr key={i.id} className="border-b last:border-0">
